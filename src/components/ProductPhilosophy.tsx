...
const productPhilosophies: PhilosophyItem[] = [
  ...
  },
  {
    ...
    quote:
      'Iterate to greatness. Balance business goals with craft by shipping continuous improvements and avoiding the perfection trap.',
    attribution: 'Vercel',
  },
  {
    category: 'Simplicity',
    ...
    <Section gap={SectionGap.lg} id='product-philosophy'>
      <SectionHeader>
        ...
        <Body color='secondary'>
          ...
          These shape how I approach every design challenge.
        </Body>
      </SectionHeader>
