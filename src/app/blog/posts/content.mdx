...
<CodeBlock
  ...
  codes={[
    ...
    location: "America/Wisconsin", // Expecting the IANA time zone identifier, e.g., 'Europe/Vienna'
  ...
  codes={[
    {
      code: `const home = {
    label: "Home",
    title: "André Pilch's Portfolio",
    description: "Portfolio website showcasing my work as a Design Engineer",
    headline: <>Design engineer and builder</>,
    subline: (
      <>
        I'm André Pilch, a design engineer at <InlineCode>FLY</InlineCode>, where I craft intuitive
