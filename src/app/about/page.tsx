...
import { PhilosophyMasonry } from "@/components";
...
import type { PhilosophyItem } from "@/components";
...
const productPhilosophies: PhilosophyItem[] = [
  ...
  },
  {
    ...
    attribution: "Vercel Design Engineering",
  },
  {
    category: "Focus",
...
export default function About() {
  return (
    <div className={styles.pageWrapper}>
      ...
      {/* Product Philosophy Masonry */}
      <section className={styles.section} id="product-philosophy">
        <div className={styles.container}>
          <div className={styles.sectionContent}>
            <div className={styles.sectionHeader}>
              <p className={styles.eyebrow}>Product Thinking</p>
              <h2 className={styles.sectionTitle}>
